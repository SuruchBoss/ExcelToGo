...
การทดสอบบนขั้นต่ำจริงคุ้มตั้งแต่รันแรก: `check:readme` ผ่านบน 22 แต่พังบน 20.9 เพราะสคริปต์ใช้
`import.meta.dirname` ซึ่งมีตั้งแต่ Node 20.11 เท่านั้น — บนเครื่องที่ตรงตามที่ README บอกไว้ สคริปต์นั้นใช้ไม่ได้เลย
