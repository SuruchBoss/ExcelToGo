...
| `npm run check:e2e` | ขับแอปจริงในเบราว์เซอร์ 5 flow: พิมพ์สูตร, ส่งออก-นำเข้า `.xlsx`, คีย์บอร์ดล้วน, undo, เสียงประกาศ (ต้อง build ก่อน) |
...
```bash
npm run check:e2e   # 5 flow ในเบราว์เซอร์จริง (ต้อง build ก่อน)
```
...
- [x] **เทสต์ที่เปิดแอปจริง (E2E) ใน CI** — ทำแล้ว: `npm run check:e2e` ขับ Chromium ผ่าน 5 flow
      ...
      ยังเหลือ: ยังไม่แตะ AI panel (ต้อง mock ตัวโมเดล), กราฟ, pivot และการลากเลือกด้วยนิ้ว
