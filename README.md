...
| `npm run check:e2e` | ขับแอปจริงในเบราว์เซอร์ 7 flow: พิมพ์สูตร, ส่งออก-นำเข้า `.xlsx`, คีย์บอร์ดล้วน, undo, เสียงประกาศ, ผู้ช่วย AI (ต้อง build ก่อน) |
...
```bash
npm run check:e2e   # 7 flow ในเบราว์เซอร์จริง (ต้อง build ก่อน)
```
...
- [x] **เทสต์ที่เปิดแอปจริง (E2E) ใน CI** — ทำแล้ว: `npm run check:e2e` ขับ Chromium ผ่าน 7 flow
