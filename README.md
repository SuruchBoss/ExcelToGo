...
- [ ] **ตรวจ accessibility อัตโนมัติใน CI** — ตอนนี้รัน axe ด้วยมือเป็นครั้งคราว ซึ่งเพิ่งพลาดมาแล้ว:
      audit รอบก่อนรันที่ความกว้างเดสก์ท็อปอย่างเดียว เลยไม่เห็นว่าปุ่มแถบเครื่องมือ 8 ปุ่มไม่มีชื่อให้
      screen reader อ่านเลยต่ำกว่า 640px (ข้อความถูกซ่อนด้วย `sm:`) ถ้าจะกันจริงต้องรันทั้งสองความกว้าง
      ในทุก PR
